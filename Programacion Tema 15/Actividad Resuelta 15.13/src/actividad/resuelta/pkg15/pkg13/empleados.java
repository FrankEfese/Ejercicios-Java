...
@NamedQueries({
    @NamedQuery(
            name = "empleados.prog",
            query = "SELECT count(e) FROM empleados e WHERE e.puesto = 'Programador'"
    ),

    @NamedQuery(
            name = "empleados.com",
            query = "SELECT count(e) FROM empleados e WHERE e.puesto = 'Comercial'"
    ),

    @NamedQuery(
            name = "empleados.bec",
            query = "SELECT count(e) FROM empleados e WHERE e.puesto = 'Becaria'"
    )
