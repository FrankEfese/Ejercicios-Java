...
public class PortatilJpaController implements Serializable {

    public PortatilJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    
     public PortatilJpaController() {
    ...
    public void create(Portatil portatil) {
