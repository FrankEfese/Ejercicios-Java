package actividad.aplicacion.pkg13.pkg19;

//Repetir la actividad anterior pero en vez de mostrar obtener una tabla de tipo String con los DNI. 
...
public class ActividadAplicacion1319 {
    ...
    public static void main(String[] args) {
        ...
        String dnis[] = Stream.of(tabla).map(x -> x.dni).toArray(String[]::new);

        System.out.println(Arrays.toString(dnis));
