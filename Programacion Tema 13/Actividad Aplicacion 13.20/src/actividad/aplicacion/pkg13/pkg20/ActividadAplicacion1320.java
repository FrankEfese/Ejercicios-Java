...
//Repetir la actividad anterior pero obteniendo una lista. 
...
public class ActividadAplicacion1320 {
    ...
    public static void main(String[] args) {
        ...
        List<String> lista = Stream.of(tabla).map(x -> x.dni).collect(Collectors.toList());
