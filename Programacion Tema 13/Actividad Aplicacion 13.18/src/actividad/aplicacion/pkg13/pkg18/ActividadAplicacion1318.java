package actividad.aplicacion.pkg13.pkg18;

//A partir de una tabla de Socios , crea un Stream ordenado por DNI.
import java.time.LocalDate;
import java.time.Month;
import java.util.*;
import java.util.stream.Stream;

public class ActividadAplicacion1318 {
    ...
    public static void main(String[] args) {
        ...
        Stream.of(tabla).sorted().forEach(f -> System.out.println(f));
    }
