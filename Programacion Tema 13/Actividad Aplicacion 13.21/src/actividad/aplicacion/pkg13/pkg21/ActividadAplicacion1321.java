package actividad.aplicacion.pkg13.pkg21;

//Repetir la actividad anterior obteniendo una lista con los nombres ordenados. 
...
public class ActividadAplicacion1321 {
    ...
    public static void main(String[] args) {
        ...
        List<String> lista = Stream.of(tabla).sorted((x, v) -> x.nombre.compareTo(v.nombre)).map(x -> x.nombre).collect(Collectors.toList());
